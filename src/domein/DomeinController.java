...
public class DomeinController
{
    ...
    public void maakFinaleVragen()
    {
        ...
        Vraag vraag2 = new Vraag("Welke mensen maken deel uit van een \n gemeenteraad?", antwoorden2);
        List<String> antwoorden3 = new ArrayList<>();
        antwoorden3.add("Tremor");
        antwoorden3.add("The Hum");
        antwoorden3.add("Ocarina");
        antwoorden3.add("Stampede");
        antwoorden3.add("The way we see the world");
        Vraag vraag3 = new Vraag("Wat zijn op Youtube de 5 populairste liedjes van \n Dimitri Vegas & Like Mike?", antwoorden3);
        List<String> antwoorden4 = new ArrayList<>();
        ...
        Vraag vraag7= new Vraag("Vul woord per woord aan. Al die willen \n te kaap'ren varen, ...", antwoorden7);
        ...
        Vraag vraag9 = new Vraag("Wat zijn de vijf volgende inhoudsmaten: \n milliliter, centiliter, ...", antwoorden9);
        ...
        antwoorden10.add("UK");
        Vraag vraag10 = new Vraag("Welke landen hebben de grootste economieën \n ter wereld?", antwoorden10);
        ...
        Vraag vraag11 = new Vraag("Films en boeken, maar wat weet je verder \n nog over Koning Arthur?", antwoorden11);
